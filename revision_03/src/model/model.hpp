...
struct Model
{
    ...
    float m_rotate_rad;
    Math::Core::Vec3_f m_rotate_axis;
    //---------------------------------------------------------------------------------------------------------------------//
    ...
    Model()
    {
        ...
        m_rotate_rad = 0.0f;
        m_rotate_axis = Math::Core::Vec3_f();
    }
    ...
    {
        Math::Core::Vec3_f move(x_axis, y_axis, z_axis);
        move = move * offset;
        m_position = m_position + move;
    }

    void renderModel(Renderer& renderer, const Math::Core::Mat4_f& projection_view_matrix, bool draw_filled, float color_mix);
    //---------------------------------------------------------------------------------------------------------------------//
