...
// ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### //
float Math::Core::convertDegreesToRadians(const float degrees)
{
...
*/
uint32_t Math::Core::convertVec3fToColor(const Math::Core::Vec3_f& color)
{
...
*/
uint32_t Math::Core::convertVec4fToColor(const Math::Core::Vec4_f& color)
{
