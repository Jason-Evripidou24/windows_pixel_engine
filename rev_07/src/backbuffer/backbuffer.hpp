...
struct Backbuffer
{
    ...
    void setCharacter(int x, int y, char character, uint32_t color);
...
struct AsciiFont
{
    //---------------------------------------------------------------------------------------------------------------------//
    int m_glyph_width      = 8;
    int m_glyph_height     = 8;
    int m_spacing          = 2;
    int m_new_line_spacing = 1;

    static inline uint8_t m_ascii_font_basic_bitmap[128][8]
    {
...
static const AsciiFont g_asciiFont;
// ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### //
