...
*/
std::vector<Math::Triangle> Renderer::clipTriangleMinX(const Math::Triangle& triangle, const float min_x_plane)
{
    //---------------------------------------------------------------------------------------------------------------------//
    ...
    */
    ...
    {
        Math::Vertex intersection_vert_0 = this->intersectionWithPlaneX(vert_0, vert_1, min_x_plane);
        Math::Vertex intersection_vert_1 = this->intersectionWithPlaneX(vert_0, vert_2, min_x_plane);
    ...
    {
        Math::Vertex intersection_vert_0 = this->intersectionWithPlaneX(vert_1, vert_0, min_x_plane);
        Math::Vertex intersection_vert_1 = this->intersectionWithPlaneX(vert_1, vert_2, min_x_plane);
    ...
    {
        Math::Vertex intersection_vert_0 = this->intersectionWithPlaneX(vert_2, vert_0, min_x_plane);
        Math::Vertex intersection_vert_1 = this->intersectionWithPlaneX(vert_2, vert_1, min_x_plane);
    ...
    */
    ...
    {
        Math::Vertex intersection_vert_0 = this->intersectionWithPlaneX(vert_0, vert_2, min_x_plane);
        Math::Vertex intersection_vert_1 = this->intersectionWithPlaneX(vert_1, vert_2, min_x_plane);
    ...
    {
        Math::Vertex intersection_vert_0 = this->intersectionWithPlaneX(vert_1, vert_0, min_x_plane);
        Math::Vertex intersection_vert_1 = this->intersectionWithPlaneX(vert_2, vert_0, min_x_plane);
...
-   Triangle is (should be) within clip space.
*/
std::vector<Math::Triangle> Renderer::clipTriangleMaxX(const Math::Triangle& triangle, const float max_x_plane)
{
    //---------------------------------------------------------------------------------------------------------------------//
    const Math::Vertex& vert_0 = triangle.m_vertices[0];
    const Math::Vertex& vert_1 = triangle.m_vertices[1];
    ...
    */
    if( (vert_0_in_bounds == true) && (vert_1_in_bounds == false) && (vert_2_in_bounds == false) )
    {
        Math::Vertex intersection_vert_0 = this->intersectionWithPlaneX(vert_0, vert_1, max_x_plane);
        Math::Vertex intersection_vert_1 = this->intersectionWithPlaneX(vert_0, vert_2, max_x_plane);
    ...
    {
        Math::Vertex intersection_vert_0 = this->intersectionWithPlaneX(vert_1, vert_0, max_x_plane);
        Math::Vertex intersection_vert_1 = this->intersectionWithPlaneX(vert_1, vert_2, max_x_plane);
    ...
    {
        Math::Vertex intersection_vert_0 = this->intersectionWithPlaneX(vert_2, vert_0, max_x_plane);
        Math::Vertex intersection_vert_1 = this->intersectionWithPlaneX(vert_2, vert_1, max_x_plane);
    ...
    */
    if( (vert_0_in_bounds == true) && (vert_1_in_bounds == true) && (vert_2_in_bounds == false) )
    {
        Math::Vertex intersection_vert_0 = this->intersectionWithPlaneX(vert_0, vert_2, max_x_plane);
        Math::Vertex intersection_vert_1 = this->intersectionWithPlaneX(vert_1, vert_2, max_x_plane);
    ...
    {
        Math::Vertex intersection_vert_0 = this->intersectionWithPlaneX(vert_1, vert_0, max_x_plane);
        Math::Vertex intersection_vert_1 = this->intersectionWithPlaneX(vert_2, vert_0, max_x_plane);
...
// ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### //
std::vector<Math::Triangle> Renderer::clipTriangleBetweenX
(
...
{
    std::vector<Math::Triangle> clipped_to_min = this->clipTriangleMinX(triangle, min_x_plane);

    std::vector<Math::Triangle> result;
    for(const Math::Triangle& triangle_clip_min : clipped_to_min)
    {
        std::vector<Math::Triangle> clipped_to_min_max = this->clipTriangleMaxX(triangle_clip_min, max_x_plane);
