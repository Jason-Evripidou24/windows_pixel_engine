...
{
    return (vec_l.m_data[0] * vec_r.m_data[0]) + (vec_l.m_data[1] * vec_r.m_data[1]);
}
// ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### //
...
{
    return (vec_l.m_data[0] * vec_r.m_data[0]) + (vec_l.m_data[1] * vec_r.m_data[1]) + (vec_l.m_data[2] * vec_r.m_data[2]);
}
// ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### //
...
// ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### //
/*
-   Vec3_f normalised_device_coords = {x, y, z == depth};
*/
Vec3_f Math::normalisedDeviceCoordsToScreenCoords
(
...
)
{
    ...
    float x = (normalised_device_coords.m_data[0] + 1.0f) * 0.5f * framebuffer_width;
    float y = (1.0f - normalised_device_coords.m_data[1]) * 0.5f * framebuffer_height;

    new_vec.m_data[0] = (normalised_device_coords.m_data[0] + 1.0f) * 0.5f * framebuffer_width;
    new_vec.m_data[1] = (1.0f - normalised_device_coords.m_data[1]) * 0.5f * framebuffer_height;
    new_vec.m_data[2] = normalised_device_coords.m_data[2];
