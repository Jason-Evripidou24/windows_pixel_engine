...
)
{
    ...
    {
        int x = m_backbuffer->toBackbufferCoordX(polygon->m_vertices[i].m_position.m_data[0]);
        int y = m_backbuffer->toBackbufferCoordY(polygon->m_vertices[i].m_position.m_data[1]);
