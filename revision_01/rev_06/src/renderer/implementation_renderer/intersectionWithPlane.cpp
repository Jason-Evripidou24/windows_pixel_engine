...
*/
Math::Vertex Renderer::intersectionWithPlaneX(const Math::Vertex& v_0, const Math::Vertex& v_1, const float plane_x)
{
...
*/
Math::Vertex Renderer::intersectionWithPlaneY(const Math::Vertex& v_0, const Math::Vertex& v_1, const float plane_y)
{
...
*/
Math::Vertex Renderer::intersectionWithPlaneZ(const Math::Vertex& v_0, const Math::Vertex& v_1, const float plane_z)
{
