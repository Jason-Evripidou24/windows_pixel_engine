...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE, LPSTR, int)
{
    ...
    loaded_cube_mesh.loadMeshObjFile("../assets/backpack/", "obj.obj");
    ...
    while(window.processMessages())
    {
        ...
        */
        ...
        std::queue<MaterialTriangle> model_material_triangles = cube_models[9].transformModelForRendering(proj_view_matrix);
        renderer.drawMaterialTriangles(model_material_triangles, draw_filled, vertex_material_color_mix);
