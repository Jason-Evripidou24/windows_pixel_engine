...
std::vector<Math::Triangle> Math::clipAgainstPlaneMinY(const Math::Triangle& triangle)
{
    ...
    bool checkInsideV0 = Math::checkVertexInsidePlaneMinY(v0);
    bool checkInsideV1 = Math::checkVertexInsidePlaneMinY(v1);
    bool checkInsideV2 = Math::checkVertexInsidePlaneMinY(v2);
    ...
    {
        const Math::Vertex new_vert_0 = Math::lineIntersectionWithPlaneMinY(v0, v1);
        const Math::Vertex new_vert_1 = Math::lineIntersectionWithPlaneMinY(v0, v2);
        output.push_back(Math::Triangle(v0, new_vert_0, new_vert_1));
        return output;
    }
    if( (checkInsideV0 == false) && (checkInsideV1 == true) && (checkInsideV2 == false) )
    {
        const Math::Vertex new_vert_0 = Math::lineIntersectionWithPlaneMinY(v1, v0);
        const Math::Vertex new_vert_1 = Math::lineIntersectionWithPlaneMinY(v1, v2);
        output.push_back(Math::Triangle(v1, new_vert_0, new_vert_1));
        return output;
    }
    if( (checkInsideV0 == false) && (checkInsideV1 == false) && (checkInsideV2 == true) )
    {
        const Math::Vertex new_vert_0 = Math::lineIntersectionWithPlaneMinY(v2, v0);
        const Math::Vertex new_vert_1 = Math::lineIntersectionWithPlaneMinY(v2, v1);
    ...
    {
        const Math::Vertex new_vert_0 = Math::lineIntersectionWithPlaneMinY(v0, v2);
        const Math::Vertex new_vert_1 = Math::lineIntersectionWithPlaneMinY(v1, v2);
    ...
    {
        const Math::Vertex new_vert_0 = Math::lineIntersectionWithPlaneMinY(v1, v0);
        const Math::Vertex new_vert_1 = Math::lineIntersectionWithPlaneMinY(v2, v0);
