...
// ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### //
std::vector<Math::Vertex> Math::clipPolygonAgainstPlaneMaxX(std::vector<Math::Vertex>& polygon)
{
    ...
    for(size_t i = 0; i < polygon.size(); i++)
    {
        ...
        {
            clipped_polygon.push_back( Math::lineIntersectionWithPlaneMaxX(previous, current) );
        }
