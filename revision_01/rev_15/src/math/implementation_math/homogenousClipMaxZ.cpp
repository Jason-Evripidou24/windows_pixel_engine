...
// ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### //
std::vector<Math::Vertex> Math::clipPolygonAgainstPlaneMaxZ(std::vector<Math::Vertex>& polygon)
{
    ...
    for(size_t i = 0; i < polygon.size(); i++)
    {
        ...
        {
            clipped_polygon.push_back( Math::lineIntersectionWithPlaneMaxZ(previous, current) );
        }
