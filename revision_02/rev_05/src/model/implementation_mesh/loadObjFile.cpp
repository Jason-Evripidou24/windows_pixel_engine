...
// ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### //
std::vector<Math::Vertex> createPolygon
(
...
{
    std::vector<Math::Vertex> new_polygon;
    ...
    for(size_t i = 0; i < face_vertices.size(); i++)
    {
        ...
        new_polygon.push_back(new_vertex);
        //-----------------------------------------------------------------------------------------------------------------//
    }
...
void Mesh::loadObjFile(const std::string& file_folder, const std::string& filename)
{
    ...
    while(std::getline(file, line))
    {
        ...
        else if(prefix == "f")
        {
            ...
            std::vector<Math::Vertex> new_polygon = createPolygon
            (
                face_indices,
