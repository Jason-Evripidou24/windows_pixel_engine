...
namespace Math
{
    ...
    std::vector<Math::Vertex> clipPolygonAgainstPlaneMinX(std::vector<Math::Vertex>& polygon);
    ...
    std::vector<Math::Vertex> clipPolygonAgainstPlaneMaxX(std::vector<Math::Vertex>& polygon);
    ...
    std::vector<Math::Vertex> clipPolygonAgainstPlaneMinY(std::vector<Math::Vertex>& polygon);
    ...
    std::vector<Math::Vertex> clipPolygonAgainstPlaneMaxY(std::vector<Math::Vertex>& polygon);
    ...
    std::vector<Math::Vertex> clipPolygonAgainstPlaneMinZ(std::vector<Math::Vertex>& polygon);
    ...
    std::vector<Math::Vertex> clipPolygonAgainstPlaneMaxZ(std::vector<Math::Vertex>& polygon);
    //---------------------------------------------------------------------------------------------------------------------//
