...
// ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### //
std::vector<Math::Vertex> Math::clipPolygonAgainstPlaneMaxY(std::vector<Math::Vertex>& polygon)
{
    ...
    for(size_t i = 0; i < polygon.size(); i++)
    {
        ...
        {
            clipped_polygon.push_back( Math::lineIntersectionWithPlaneMaxY(previous, current) );
        }
