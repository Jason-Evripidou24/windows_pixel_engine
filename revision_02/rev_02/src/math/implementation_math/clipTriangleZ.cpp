...
*/
std::vector<Math::Triangle> Math::clipTriangleMinZ(const Math::Triangle& triangle, const float min_z_plane)
{
    //---------------------------------------------------------------------------------------------------------------------//
    ...
    */
    ...
    {
        Math::Vertex intersection_vert_0 = Math::intersectionWithPlaneZ(vert_0, vert_1, min_z_plane);
        Math::Vertex intersection_vert_1 = Math::intersectionWithPlaneZ(vert_0, vert_2, min_z_plane);
    ...
    {
        Math::Vertex intersection_vert_0 = Math::intersectionWithPlaneZ(vert_1, vert_0, min_z_plane);
        Math::Vertex intersection_vert_1 = Math::intersectionWithPlaneZ(vert_1, vert_2, min_z_plane);
    ...
    {
        Math::Vertex intersection_vert_0 = Math::intersectionWithPlaneZ(vert_2, vert_0, min_z_plane);
        Math::Vertex intersection_vert_1 = Math::intersectionWithPlaneZ(vert_2, vert_1, min_z_plane);
    ...
    */
    ...
    {
        Math::Vertex intersection_vert_0 = Math::intersectionWithPlaneZ(vert_0, vert_2, min_z_plane);
        Math::Vertex intersection_vert_1 = Math::intersectionWithPlaneZ(vert_1, vert_2, min_z_plane);
    ...
    {
        Math::Vertex intersection_vert_0 = Math::intersectionWithPlaneZ(vert_1, vert_0, min_z_plane);
        Math::Vertex intersection_vert_1 = Math::intersectionWithPlaneZ(vert_2, vert_0, min_z_plane);
...
-   Triangle is (should be) within clip space.
*/
std::vector<Math::Triangle> Math::clipTriangleMaxZ(const Math::Triangle& triangle, const float max_z_plane)
{
    //---------------------------------------------------------------------------------------------------------------------//
    const Math::Vertex& vert_0 = triangle.m_v0;
    const Math::Vertex& vert_1 = triangle.m_v1;
    ...
    */
    if( (vert_0_in_bounds == true) && (vert_1_in_bounds == false) && (vert_2_in_bounds == false) )
    {
        Math::Vertex intersection_vert_0 = Math::intersectionWithPlaneZ(vert_0, vert_1, max_z_plane);
        Math::Vertex intersection_vert_1 = Math::intersectionWithPlaneZ(vert_0, vert_2, max_z_plane);
    ...
    {
        Math::Vertex intersection_vert_0 = Math::intersectionWithPlaneZ(vert_1, vert_0, max_z_plane);
        Math::Vertex intersection_vert_1 = Math::intersectionWithPlaneZ(vert_1, vert_2, max_z_plane);
    ...
    {
        Math::Vertex intersection_vert_0 = Math::intersectionWithPlaneZ(vert_2, vert_0, max_z_plane);
        Math::Vertex intersection_vert_1 = Math::intersectionWithPlaneZ(vert_2, vert_1, max_z_plane);
    ...
    */
    if( (vert_0_in_bounds == true) && (vert_1_in_bounds == true) && (vert_2_in_bounds == false) )
    {
        Math::Vertex intersection_vert_0 = Math::intersectionWithPlaneZ(vert_0, vert_2, max_z_plane);
        Math::Vertex intersection_vert_1 = Math::intersectionWithPlaneZ(vert_1, vert_2, max_z_plane);
    ...
    {
        Math::Vertex intersection_vert_0 = Math::intersectionWithPlaneZ(vert_1, vert_0, max_z_plane);
        Math::Vertex intersection_vert_1 = Math::intersectionWithPlaneZ(vert_2, vert_0, max_z_plane);
...
// ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### //
std::vector<Math::Triangle> Math::clipTriangleBetweenZ
(
...
{
    std::vector<Math::Triangle> clipped_to_min = Math::clipTriangleMinZ(triangle, min_z_plane);

    std::vector<Math::Triangle> result;
    for(const Math::Triangle& triangle_clip_min : clipped_to_min)
    {
        std::vector<Math::Triangle> clipped_to_min_max = Math::clipTriangleMaxZ(triangle_clip_min, max_z_plane);
