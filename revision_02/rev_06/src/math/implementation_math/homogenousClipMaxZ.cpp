...
// ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### ##### //
void Math::clipPolygonAgainstPlaneMaxZ(std::vector<Math::Vertex>& output, const std::vector<Math::Vertex>& polygon)
{
    output.clear();
    ...
    for(size_t i = 0; i < polygon.size(); i++)
    {
        ...
        {
            output.push_back( Math::lineIntersectionWithPlaneMaxZ(previous, current) );
        }
